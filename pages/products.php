...
// Get the product name from category and set it to $product name
$product_name = "";// the name of the product
$sql = "SELECT * FROM products WHERE category_id = (SELECT id FROM categories WHERE name = '{$product_name}')";
